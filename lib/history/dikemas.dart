    ...
    if(diskonProduk[index] > 0){
      return Row(
        ...
        children: <Widget>[
          ...
          Flexible(
            child: new Text(
              "Rp. "+ hargaDiskonProduk[index].toString(),
              style: TextStyle(
                  fontSize: 15.0,
         ...
         child: new ListView.builder(
           ...
           itemBuilder: (BuildContext context, int index) {
                   ...
                   child: Stack(
                     children: <Widget>[
                       Container(
                         ...
                         children: <Widget>[
                         Expanded(
                         child:  Text("Sedang Dikemas",textAlign: TextAlign.right),
                       ),
            ...
            totalProduk[index] > 1 ?
             ...
             Padding(padding: EdgeInsets.only(left: 10)),
             Expanded(
              child:Text("Produk dikirim sebelum  "+ formatDate.format(DateTime(DateTime.now().year, DateTime.now().month, DateTime.now().day + 1)) ,textAlign: TextAlign.left),
             ),
             RaisedButton(
             child: Text(" Hubungi Penjual "),
             onPressed: (){
              // getDataPegawai(context,index);
             },
