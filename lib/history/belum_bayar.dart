                    ...
                    child:SafeArea(
                      child: new ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return InkWell(
                              onTap: (){
                                // Navigator.push(context, MaterialPageRoute(builder: (context) => RincianPesanan(status: StoragePrefix.StatusBelumBayar,idPesanan: _listHistory[index]['id_pesanan'].toString())));
                              },
                              child: Card(
                                child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: <Widget>[
                                              Row(
                                                children: <Widget>[
                                                  Expanded(
                                                    child:  Text("Belum Bayar",textAlign: TextAlign.right),
                                                  ),
                                              ...
                                              Row(
                                                children: <Widget>[
                                                  ...
                                                  Expanded(
                                                    child:  Text("Jumlah Harus Dibayar : Rp. "+ totalBayar[index],textAlign: TextAlign.right),
                                                  ),
                                                  Padding(padding: EdgeInsets.only(right: 10))
                                                ],
                                              ),
                                              ...
                                              Row(
                                                ...
                                                children: <Widget>[
                                                  Padding(padding: EdgeInsets.only(left: 10)),
                                                  Expanded(
                                                    child:Text("Bayar Sebelum "+ formatDate.format(DateTime(DateTime.now().year, DateTime.now().month, DateTime.now().day + 1)) ,textAlign: TextAlign.left),
                                                  ),
                    ...
                    child:SafeArea(
                      child: new ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return InkWell(
                              onTap: (){
                                // Navigator.push(context, MaterialPageRoute(builder: (context) => RincianPesanan(status: StoragePrefix.StatusBelumBayar,idPesanan: _listHistoryKonsul[index]['id_pesanan'].toString())));
                              },
                              child: Card(
                                child: Padding(
                                  padding: EdgeInsets.only(top: 10.0, bottom: 10.0),
